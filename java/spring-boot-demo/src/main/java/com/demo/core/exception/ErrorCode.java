...
public enum ErrorCode {
    ...
    ACCESS_DATA_WORKFLOW_ERROR(300602, "没有当前流程的权限"),
    ACCESS_DATA_WORKFLOW_HANDLE_ERROR(300603, "当前流程已被其他人处理"),
    ...
    PARAMS_ERROR_RESET_CODE_REPEAT(400106, "重置码错误"),
    PARAMS_ERROR_PASSWORD_LOW(400107, "密码强度过低"),
    PARAMS_ERROR_WORKFLOW_NODE_ERROR(400108, "流程节点数据异常"),
